...
void output_UCA(uca_org_t *fr)
{
  ...
  if (g_ip->print_detail)
  {
    ...
    cout <<  "\tBitline cap of a subarray: " <<
       fr->data_array2->C_bl_subarray << endl;
    cout <<  "\tLoad cap output driver 1: " <<
       fr->data_array2->C_ld_outdrv_1 << endl;
  cout <<  "\tLoad cap output driver 2: " <<
       fr->data_array2->C_ld_outdrv_2 << endl;
  cout <<  "\tLoad cap output driver 3: " <<
       fr->data_array2->C_ld_outdrv_3 << endl;
  cout <<  "\tLoad cap output driver 4: " <<
       fr->data_array2->C_ld_outdrv_4 << endl;
  cout <<  "\tmat output driver power: " <<
       fr->data_array2->power_output_drv << endl;
