    ...
    bool is_main_mem)
{
  ...
  else
  {
    ...
    ptr_array->C_bl_subarray = uca->bank.mat.subarray.C_bl;
    ptr_array->C_ld_outdrv_1 = uca->bank.mat.C_ld_1;
    ptr_array->C_ld_outdrv_2 = uca->bank.mat.C_ld_2;
    ptr_array->C_ld_outdrv_3 = uca->bank.mat.C_ld_3;
    ptr_array->C_ld_outdrv_4 = uca->bank.mat.C_ld_4;
    ptr_array->power_output_drv = uca->bank.mat.power_output_driver;
